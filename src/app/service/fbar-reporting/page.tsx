        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="p-8 border border-white/10 rounded-2xl bg-white/5">
              ...
              <p className="text-white/60 leading-relaxed">Preparation and filing of your FBAR to report foreign financial accounts exceeding $10,000.</p>
            </div>
            <div className="p-8 border border-white/10 rounded-2xl bg-white/5">
              <h3 className="text-2xl font-bold mb-4">Form 8938 (FATCA)</h3>
              <p className="text-white/60 leading-relaxed">Reporting specified foreign financial assets on your tax return as required by FATCA.</p>
            </div>
            <div className="p-8 border border-white/10 rounded-2xl bg-white/5">
              <h3 className="text-2xl font-bold mb-4">Foreign Account Analysis</h3>
              <p className="text-white/60 leading-relaxed">Comprehensive review of your foreign accounts to determine reporting requirements.</p>
            </div>
            <div className="p-8 border border-white/10 rounded-2xl bg-white/5">
              <h3 className="text-2xl font-bold mb-4">Voluntary Disclosure</h3>
              <p className="text-white/60 leading-relaxed">Assistance with voluntary disclosure programs if you've missed prior reporting deadlines.</p>
            </div>
          </motion.div>
        </div>
      </section>
